...
| _(optional)_ `SUPABASE SERVICE_ROLE_KEY` (server-side functions) | Supabase Settings → API               | **Do NOT bundle in app** – store in server / edge functions | planned API calls     |
...
_(Remove if migrating fully to Supabase.)_
